...
public class TestBase implements SauceOnDemandSessionIdProvider {
    ...
    public static String accessKey = System.getenv("API_KEY");
    ...
    @Rule
    public TestObjectTestResultWatcher resultReportingTestWatcher = new TestObjectTestResultWatcher();
     ...
     * i n the String array are used as part of the invocation of the test constructor
     */
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"Android", "OnePlus 5", "8.0", "1.5.3", "portrait"});
        browsers.add(new String[]{"Android", "HTC U11", "8.0", "1.5.3", "portrait"});
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("testobject_suite_name", "OI");
        capabilities.setCapability("testobject_test_name", "shopping List");
        ...
        /*SL this.driver = new AndroidDriver(
        ...
        /* LOCAL this.driver = new AndroidDriver(
                new URL("http://" + seleniumURI + "/wd/hub"),
                capabilities); */

        resultReportingTestWatcher.setRemoteWebDriver(this.driver);

        this.sessionId = driver.getSessionId().toString();
    }

    /*@After //not required for TO tests
...
*/
    ...
    public static void setupClass() {
        ...
        seleniumURI = "eu1.appium.testobject.com";
        //seleniumURI = "@ondemand.saucelabs.com:443";`
        //seleniumURI = "localhost:4723";
